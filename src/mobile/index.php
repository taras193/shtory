...
<header id="m-sect1">
    <div class="wrap">
        <div class="head">
            <div class="fone">
                <a href="tel:+79055816464"><span class="lptracker_phone">+7 (905) 581-64-64</span></a>
        ...
        <h2>За 3 дня создадим<br> уютную атмосферу за счет<br> индивидуального<br> оформления штор<br> и дополнений под ключ</h2>
...
<section class="sec3" id="m-sect3">
    ...
    <div class="form_gr">
       <div class="slid1 calc-step active" data-step="1">
           <h3>Для чего необходимо<br> подобрать шторы<br> и оформить интерьер?</h3>
           <a href="" class="var1">Квартира / Дом</a>
           <a href="" class="var2">Организации</a>
           <a href="" class="var3">Мероприятие</a>
        </div>
...
<section class="sec4" id="m-sect4">
    <div class="wrap">
        ...
        <div class="prob_gr">
            <p>Затянутые сроки<br><span>Зачастую услугу по<br> разработке штор<br> предлагают посредники,<br>
            без своего производства</span></p>
...
<section class="sec5" id="m-sect5">
    <div class="wrap">
        ...
        <div class="cifri">
            ...
            <div>
                <h4>27</h4>
                <p>сотрудников на<br>производстве</p>
            </div>
            <div>
                <h4>2</h4>
            ...
            <div>
                <h4><span>Более</span><br>5000</h4>
                <p>клиентов</p>
            </div>
            
        </div>
        <div class="form_gr">
        <h3>Получите консультацию<br> от дизайнера с опытом<br> 10 лет прямо сейчас</h3>
        <form action="ajax/mail.php" method="POST">
            <input type="text" name="name" placeholder="Введите имя">
            <input type="text" name="phone" placeholder="Введите телефон">
        ...
        <div class="bxslider2">
            <div class="bx-slider-2-w" id="bx_otz">
                <div class="bx-slider-2-slide">
                    <img src="img/logo.png" data-original="img/slider/slid_b1.jpg" alt="" width="480" height="247" class="lazy"/>
                    <div class="div">
                ...
                <div class="bx-slider-2-slide">
                    <img src="img/logo.png" data-original="img/slider/slid_b2.jpg" alt="" width="480" height="247" class="lazy"/>
                    <div class="div">
                ...
                <div class="bx-slider-2-slide">
                    <img src="img/logo.png" data-original="img/slider/slid_b3.jpg" alt="" width="480" height="247" class="lazy"/>
                    <div class="div">
                ...
                <div class="bx-slider-2-slide">
                    <img src="img/logo.png" data-original="img/slider/slid_b4.jpg" alt="" width="480" height="247" class="lazy"/>
                    <div class="div">
    ...
    <!--div class="point">
        ...
        <div class="vop_okno">        
            ...
            <div class="fon_vop">
                ...
                <a href="tel:+79055816464" class="click_fone"><span class="lptracker_phone">+7 (905) 581-64-64</span></a>
                </div>
            </div>
...
<div id="hidden-box">
 ...
 <div>Телефон: <span class="tel lptracker_phone">+7 (905) 581-64-64</span></div>
